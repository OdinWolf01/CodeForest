...
$(document).ready(function(){
  $('#media_recent_display').empty();
<?
if(isset($other_memberID) && isset($_GET['id']) && $other_memberID !== false && isset($other_profileID)){
  echo "  $.post('/media.php', {'recent': ".'"'.$other_profileID.'"'."}, function(data){".PHP_EOL;
}else{
  echo "  $.post('/media.php', {'recent': ''}, function(data){".PHP_EOL;
}
?>
    $.each(data, function(key, value){
      var new_repeater = $('#media_recent_repeater').clone();
      ...
      $('#media_recent_display').append(new_repeater);
      new_repeater.show();
    });
  }, 'json');
  $('#media_recent_display').show();
});
...
<div class="media_recent">
  <div id='media_recent_display' class="row" style='display: none;'></div>
  <div  id='media_recent_repeater' style='display: none;'>
<ul>
<li>
  <div class="grid">
  <a style="width: 50px;height: 50px;overflow: scroll;" data-fancybox="mygallery" href="/media.php?view={Url}">

  <img  style="margin:3px;overflow: scroll " src="/media.php?view={Url}" height="80px" width="80px" >
